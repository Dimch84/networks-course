...
(в images так же лежит картинка, которая передавалась)
...
#### Решение
Пропускная способность будет min(200 Кбит/с, 3 Мбит/с, 2 Мбит/с), то есть 200 Кбит/с. 
5 Мбайт / 200 Кбит/с = 5 * 10^3 * 8 Кбит / 200 Кбит/с = 200 секунд.
Ответ: 200 секунд.
